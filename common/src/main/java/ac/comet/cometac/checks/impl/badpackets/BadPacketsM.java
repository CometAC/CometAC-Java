...
@CheckData(name = "BadPacketsM", stableKey = "cometac.badpackets.respawn_alive", description = "Tried to respawn while alive", experimental = true)
public class BadPacketsM extends Check implements PacketCheck {
    public BadPacketsM(final CometPlayer player) {
        super(player);
    }
