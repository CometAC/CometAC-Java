...
@CheckData(name = "PacketOrderF", stableKey = "cometac.packetorder.input_tick_to_sneak_sprint_order", experimental = true, verboseVersion = 1)
public class PacketOrderF extends Check implements PostPredictionCheck {
    ...
    public PacketOrderF(CometPlayer player) {
        super(player);
    }
