...
@CheckData(name = "PacketOrderG", stableKey = "cometac.packetorder.hotbar_inventory_manage_order", experimental = true, verboseVersion = 1)
public class PacketOrderG extends Check implements PostPredictionCheck {
    ...
    public PacketOrderG(CometPlayer player) {
        super(player);
    }
