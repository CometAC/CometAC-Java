...
@CheckData(name = "AirLiquidPlace", stableKey = "cometac.scaffolding.air_liquid_place", description = "Placed a block against an invalid support")
public class AirLiquidPlace extends BlockPlaceCheck {
    public AirLiquidPlace(CometPlayer player) {
        super(player);
    }
    ...
    public void onBlockPlace(final BlockPlace place) {
        ...
        int currentTick = CometAPI.INSTANCE.getTickManager().currentTick;
