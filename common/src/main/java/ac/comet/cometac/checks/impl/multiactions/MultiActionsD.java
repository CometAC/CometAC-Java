...
@CheckData(name = "MultiActionsD", stableKey = "cometac.multiactions.inventory_close_while_moving", verboseVersion = 1, description = "Closed inventory while moving")
public class MultiActionsD extends Check implements PacketCheck {
    ...
    public MultiActionsD(CometPlayer player) {
        super(player);
    }
