...
@CheckData(name = "BadPacketsR", stableKey = "cometac.badpackets.position_starvation", verboseVersion = 1, decay = 0.25, experimental = true)
public class BadPacketsR extends Check implements PacketCheck {
    ...
    public BadPacketsR(final CometPlayer player) {
        super(player);
    }
