package ac.comet.cometac.checks.impl.groundspoof;
...
@CheckData(name = "NoFall", stableKey = "cometac.groundspoof.no_fall", setback = 10)
public class NoFall extends Check implements PacketCheck {

    public boolean flipPlayerGroundStatus = false;

    public NoFall(CometPlayer player) {
        super(player);
    }
