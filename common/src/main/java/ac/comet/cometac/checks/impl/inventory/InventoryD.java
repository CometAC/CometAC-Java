...
import ac.comet.cometac.utils.data.VectorData.MoveVectorData;
import ac.comet.cometac.utils.data.VehicleData;

import java.util.StringJoiner;

@CheckData(name = "InventoryD", stableKey = "cometac.inventory.action_while_open", setback = 1, decay = 0.25)
public class InventoryD extends InventoryCheck {
    private int horseJumpVerbose;

    public InventoryD(CometPlayer player) {
        super(player);
    }
