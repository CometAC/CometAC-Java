...
@CheckData(name = "PacketOrderD", stableKey = "cometac.packetorder.interact_hand_order", experimental = true, verboseVersion = 1)
public class PacketOrderD extends Check implements PacketCheck {
    ...
    public PacketOrderD(final CometPlayer player) {
        super(player);
    }
