...
@CheckData(name = "PacketOrderI", stableKey = "cometac.packetorder.input_tick_order", experimental = true, verboseVersion = 1)
public class PacketOrderI extends Check implements PostPredictionCheck {
    ...
    public PacketOrderI(final CometPlayer player) {
        super(player);
    }
