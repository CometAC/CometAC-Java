...
@CheckData(name = "ElytraG", stableKey = "cometac.elytra.levitation", description = "Started gliding with levitation", experimental = true)
public class ElytraG extends Check implements PostPredictionCheck {
    private boolean setback;

    public ElytraG(CometPlayer player) {
        super(player);
    }
