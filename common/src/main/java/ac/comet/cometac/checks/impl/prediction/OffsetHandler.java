...
@CheckData(name = "Simulation", stableKey = "cometac.prediction.simulation", verboseVersion = 1, decay = 0.02)
public class OffsetHandler extends Check implements PostPredictionCheck {
    ...
    private static final CompletePredictionEvent.Channel COMPLETE_CHANNEL = CometAPI.INSTANCE.getEventBus().get(CompletePredictionEvent.class);

    public OffsetHandler(CometPlayer player) {
        super(player);
    }
