...
@CheckData(name = "BadPacketsF", stableKey = "cometac.badpackets.duplicate_sprint", verboseVersion = 1, description = "Sent duplicate sprinting status")
public class BadPacketsF extends Check implements PacketCheck {
    ...
    public BadPacketsF(CometPlayer player) {
        super(player);
    }
