...
@CheckData(name = "MultiInteractA", stableKey = "cometac.multiinteract.multiple_targets", verboseVersion = 1, description = "Interacted with multiple entities in the same tick", experimental = true)
public class MultiInteractA extends Check implements PostPredictionCheck {
    ...
    public MultiInteractA(final CometPlayer player) {
        super(player);
    }
