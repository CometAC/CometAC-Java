...
@CheckData(name = "Post", stableKey = "cometac.post.invalid_order", verboseVersion = 1)
public class Post extends Check implements PacketCheck, PostPredictionCheck {
    ...
    public Post(CometPlayer playerData) {
        super(playerData);
    }
    ...
    public void onPacketReceive(final PacketReceiveEvent event) {
        ...
        if (PLAYER_ABILITIES.equals(packetType)
            ...
            // https://github.com/CometAnticheat/Comet/issues/824
