...
@CheckData(name = "CrashC", stableKey = "cometac.crash.nan_position", verboseVersion = 1, description = "Sent non-finite position or rotation")
public class CrashC extends Check implements PacketCheck {
    ...
    public CrashC(CometPlayer playerData) {
        super(playerData);
    }
