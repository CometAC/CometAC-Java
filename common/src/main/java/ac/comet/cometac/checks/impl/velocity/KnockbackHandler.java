package ac.comet.cometac.checks.impl.velocity;
...
@CheckData(name = "AntiKB", stableKey = "cometac.velocity.anti_knockback", alternativeName = "AntiKnockback", configName = "Knockback", setback = 10, decay = 0.025, verboseVersion = 1)
public class KnockbackHandler extends Check implements PostPredictionCheck {
    ...
    public KnockbackHandler(CometPlayer player) {
        super(player);
    }
