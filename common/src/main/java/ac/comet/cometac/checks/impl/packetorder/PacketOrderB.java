...
@CheckData(name = "PacketOrderB", stableKey = "cometac.packetorder.noswing", verboseVersion = 1, description = "Did not swing for attack")
public class PacketOrderB extends Check implements PacketCheck {
    ...
    public PacketOrderB(final CometPlayer player) {
        super(player);
    }
