...
@CheckData(name = "RotationPlace", stableKey = "cometac.scaffolding.rotation_place", verboseVersion = 1, description = "Placed a block while not looking at it")
public class RotationPlace extends BlockPlaceCheck {
    ...
    public RotationPlace(CometPlayer player) {
        super(player);
    }
