...
@CheckData(name = "AirLiquidBreak", stableKey = "cometac.breaking.air_liquid_break", verboseVersion = 2, description = "Breaking a block that cannot be broken")
public class AirLiquidBreak extends Check implements BlockBreakCheck {
    ...
    public AirLiquidBreak(CometPlayer player) {
        super(player);
    }
    ...
    public void onBlockBreak(BlockBreak blockBreak) {
        ...
        int newTick = CometAPI.INSTANCE.getTickManager().currentTick;
        if (lastTick == newTick
