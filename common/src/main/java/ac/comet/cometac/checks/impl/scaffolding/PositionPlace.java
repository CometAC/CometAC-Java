...
@CheckData(name = "PositionPlace", stableKey = "cometac.scaffolding.position_place", description = "Placed a block against a hidden face")
public class PositionPlace extends BlockPlaceCheck {

    public PositionPlace(CometPlayer player) {
        super(player);
    }
