...
@CheckData(name = "InventoryF", stableKey = "cometac.inventory.click_without_open", setback = 3, description = "Sent a click window packet without a open inventory", experimental = true)
public class InventoryF extends InventoryCheck {

    public InventoryF(CometPlayer player) {
        super(player);
    }
