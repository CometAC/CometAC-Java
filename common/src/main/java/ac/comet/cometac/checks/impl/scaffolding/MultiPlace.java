...
@CheckData(name = "MultiPlace", stableKey = "cometac.scaffolding.multi_place", verboseVersion = 2, description = "Placed multiple blocks in a tick", experimental = true)
public class MultiPlace extends BlockPlaceCheck {
    ...
    public MultiPlace(CometPlayer player) {
        super(player);
    }
