...
@CheckData(name = "ElytraD", stableKey = "cometac.elytra.no_elytra", description = "Started gliding without an elytra", experimental = true)
public class ElytraD extends Check implements PostPredictionCheck {
    private boolean setback;

    public ElytraD(CometPlayer player) {
        super(player);
    }
