...
@CheckData(name = "AntiExplosion", stableKey = "cometac.velocity.anti_explosion", configName = "Explosion", setback = 10, verboseVersion = 1)
public class ExplosionHandler extends Check implements PostPredictionCheck {
    ...
    public ExplosionHandler(CometPlayer player) {
        super(player);
    }
