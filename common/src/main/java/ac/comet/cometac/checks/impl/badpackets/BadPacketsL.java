...
@CheckData(name = "BadPacketsL", stableKey = "cometac.badpackets.invalid_dig", verboseVersion = 2, description = "Sent impossible dig packet")
public class BadPacketsL extends Check implements PacketCheck {
    ...
    public BadPacketsL(CometPlayer player) {
        super(player);
    }
