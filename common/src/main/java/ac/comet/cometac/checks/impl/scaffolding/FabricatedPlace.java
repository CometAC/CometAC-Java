...
@CheckData(name = "FabricatedPlace", stableKey = "cometac.scaffolding.fabricated_place", verboseVersion = 2, description = "Sent out of bounds cursor position")
public class FabricatedPlace extends BlockPlaceCheck {
    ...
    public FabricatedPlace(CometPlayer player) {
        super(player);
    }
