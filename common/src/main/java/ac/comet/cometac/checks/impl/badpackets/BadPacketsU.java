...
@CheckData(name = "BadPacketsU", stableKey = "cometac.badpackets.invalid_block_placement", verboseVersion = 2, description = "Sent impossible use item packet")
public class BadPacketsU extends Check implements PacketCheck {
    ...
    public BadPacketsU(CometPlayer player) {
        super(player);
    }
