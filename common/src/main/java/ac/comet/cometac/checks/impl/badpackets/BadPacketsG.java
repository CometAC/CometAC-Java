...
@CheckData(name = "BadPacketsG", stableKey = "cometac.badpackets.duplicate_sneak", verboseVersion = 1, description = "Sent duplicate sneaking status")
public class BadPacketsG extends Check implements PacketCheck {
    ...
    public BadPacketsG(CometPlayer player) {
        super(player);
    }
