...
public class EntityFluidInteraction {
    ...
    public void update(final CometPlayer player, final boolean ignoreCurrent) {
        ...
        int minX = CometMath.floor(aabb.minX);
        int minY = CometMath.floor(aabb.minY);
        int minZ = CometMath.floor(aabb.minZ);
        int maxX = CometMath.ceil(aabb.maxX) - 1;
        int maxY = CometMath.ceil(aabb.maxY) - 1;
        int maxZ = CometMath.ceil(aabb.maxZ) - 1;
        ...
        int playerX = CometMath.floor(player.lastX);
        double playerEyeY = player.lastY + player.getEyeHeight() - 0.1111111119389534D;
        int playerZ = CometMath.floor(player.lastZ);
    ...
    public void applyCurrentTo(final FluidTag fluid, final CometPlayer entity, final double scale) {
    ...
    private static class Tracker {
        ...
        public void applyCurrentTo(final CometPlayer player, final double scale) {
