...
import ac.comet.cometac.predictionengine.predictions.rideable.PredictionEngineRideableLava;
import ac.comet.cometac.predictionengine.predictions.rideable.PredictionEngineRideableNormal;
import ac.comet.cometac.predictionengine.predictions.rideable.PredictionEngineRideableWater;
import ac.comet.cometac.predictionengine.predictions.rideable.PredictionEngineRideableWaterLegacy;
...
public class MovementTickerLivingVehicle extends MovementTicker {
    ...
    public MovementTickerLivingVehicle(CometPlayer player) {
        super(player);
