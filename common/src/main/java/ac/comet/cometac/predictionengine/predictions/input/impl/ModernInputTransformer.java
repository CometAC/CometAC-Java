...
import ac.comet.cometac.utils.math.Vec2;
...
public class ModernInputTransformer extends DoubleInputTransformer { // 1.21.5+
    ...
    public Vec2 modifyInput(CometPlayer player, Vec2 moveVector) {
    ...
    private float distanceToUnitSquare(Vec2 input) {
        ...
        return CometMath.sqrt(1.0F + CometMath.square(additional));
    }
    ...
    private float getItemUseSpeedMultiplier(CometPlayer player) {
