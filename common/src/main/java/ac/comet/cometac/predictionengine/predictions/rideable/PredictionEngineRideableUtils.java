...
public final class PredictionEngineRideableUtils {
    ...
    public static Set<VectorData> handleJumps(CometPlayer player, Set<VectorData> possibleVectors) {
    ...
    public static List<VectorData> applyInputsToVelocityPossibilities(Input movementVector, CometPlayer player, Set<VectorData> possibleVectors, float speed) {
    ...
    public static void applyPendingJumps(CometPlayer player) {
