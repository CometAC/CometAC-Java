...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(CometPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, CometPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(CometMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(CometMath.clamp(vector.getZ(), -0.15F, 0.15F));
