...
import ac.comet.cometac.predictionengine.predictions.rideable.PredictionEngineNautilusWater;
...
public class MovementTickerNautilus extends MovementTickerLivingVehicle {
    ...
    public MovementTickerNautilus(CometPlayer player) {
        super(player);
    ...
    public float getRiddenSpeed(CometPlayer player) {
        PacketEntityNautilus nautilus = (PacketEntityNautilus) player.compensatedEntities.self.getRiding();
