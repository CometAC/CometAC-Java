...
import ac.comet.cometac.utils.data.ReachInterpolationData;
import ac.comet.cometac.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(CometPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(CometPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(CometPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, CometPlayer player) {
    ...
    public void setPositionRaw(CometPlayer player, SimpleCollisionBox box) {
