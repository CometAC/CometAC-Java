...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(CometMath.square(this.x) + CometMath.square(this.y) + CometMath.square(this.z));
    }

    public double lengthSquared() {
        return CometMath.square(this.x) + CometMath.square(this.y) + CometMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return CometMath.square(this.x - oX) + CometMath.square(this.y - oY) + CometMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return CometMath.square(origin.x - this.x) + CometMath.square(origin.y - this.y) + CometMath.square(origin.z - this.z) <= CometMath.square(radius);
    }
    ...
    public int getBlockX() {
        return CometMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return CometMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return CometMath.mojangFloor(this.z);
    }
