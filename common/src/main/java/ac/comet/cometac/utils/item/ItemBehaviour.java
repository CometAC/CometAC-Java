...
public class ItemBehaviour {
    ...
    protected boolean testConsumableComponent(ItemStack item, CompensatedWorld world, CometPlayer player, InteractionHand hand, ItemConsumable consumable) {
    ...
    protected boolean testFoodComponent(ItemStack item, CompensatedWorld world, CometPlayer player, InteractionHand hand) {
