package ac.comet.cometac.utils.collisions.blocks;
...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(CometPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(CometPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
