...
public class DynamicChorusPlant implements CollisionFactory {
    ...
    public CollisionBox getLegacyBoundingBox(CometPlayer player, ClientVersion version, int x, int y, int z) {
    ...
    public Set<BlockFace> getLegacyStates(CometPlayer player, ClientVersion version, int x, int y, int z) {
