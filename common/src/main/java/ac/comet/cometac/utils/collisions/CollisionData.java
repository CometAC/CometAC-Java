package ac.comet.cometac.utils.collisions;

import ac.comet.cometac.player.CometPlayer;
import ac.comet.cometac.predictionengine.movementtick.MovementTickerStrider;
import ac.comet.cometac.utils.collisions.blocks.DoorHandler;
import ac.comet.cometac.utils.collisions.blocks.DynamicChest;
import ac.comet.cometac.utils.collisions.blocks.DynamicChorusPlant;
import ac.comet.cometac.utils.collisions.blocks.DynamicStair;
import ac.comet.cometac.utils.collisions.blocks.PistonBaseCollision;
import ac.comet.cometac.utils.collisions.blocks.PistonHeadCollision;
import ac.comet.cometac.utils.collisions.blocks.TrapDoorHandler;
import ac.comet.cometac.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.comet.cometac.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.comet.cometac.utils.collisions.blocks.connecting.DynamicCollisionWall;
import ac.comet.cometac.utils.collisions.datatypes.CollisionBox;
import ac.comet.cometac.utils.collisions.datatypes.CollisionFactory;
import ac.comet.cometac.utils.collisions.datatypes.ComplexCollisionBox;
import ac.comet.cometac.utils.collisions.datatypes.DynamicCollisionBox;
import ac.comet.cometac.utils.collisions.datatypes.HexCollisionBox;
import ac.comet.cometac.utils.collisions.datatypes.HexOffsetCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(CometPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(CometPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
    ...
    @Override
    public CollisionBox fetch(CometPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
