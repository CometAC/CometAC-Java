...
public record Ray(@NotNull Vector3d origin, @NotNull Vector3d direction) implements Cloneable {
    public Ray(@NotNull CometPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static @NotNull Vector3d calculateDirection(@NotNull CometPlayer player, float xRot, float yRot) {
