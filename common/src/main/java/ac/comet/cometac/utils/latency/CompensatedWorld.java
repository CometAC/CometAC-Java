...
import ac.comet.cometac.utils.data.BlockPrediction;
import ac.comet.cometac.utils.data.Pair;
import ac.comet.cometac.utils.data.PistonData;
...
public class CompensatedWorld implements PacketWorld {
    ...
    public CompensatedWorld(CometPlayer player) {
        this.player = player;
    ...
    public float getWaterFluidLevelAt(double x, double y, double z) {
        return getWaterFluidLevelAt(CometMath.floor(x), CometMath.floor(y), CometMath.floor(z));
    }
