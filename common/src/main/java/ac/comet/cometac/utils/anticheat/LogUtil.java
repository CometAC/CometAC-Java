...
public class LogUtil {
    ...
    public Logger getLogger() {
        return CometAPI.INSTANCE.getGrimPlugin().getLogger();
    }

    public void console(final String info) {
        CometAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(MessageUtil.translateAlternateColorCodes('&', info));
    }

    public void console(final Component info) {
        CometAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(info);
    }
