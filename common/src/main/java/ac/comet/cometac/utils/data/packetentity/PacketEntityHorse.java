...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(CometPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(CometPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(CometPlayer player, Set<VectorData> possibleVectors) {
        ...
        float yawRadians = CometMath.radians(player.yaw);
