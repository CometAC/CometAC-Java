...
public class GetBoundingBox {
    public static SimpleCollisionBox getCollisionBoxForPlayer(@NotNull CometPlayer player, double centerX, double centerY, double centerZ) {
        if (player.inVehicle()) {
    ...
    public static @NotNull SimpleCollisionBox getPacketEntityBoundingBox(CometPlayer player, double centerX, double minY, double centerZ, PacketEntity entity) {
    ...
    public static @NotNull SimpleCollisionBox getPlayerBoundingBox(@NotNull CometPlayer player, double centerX, double minY, double centerZ) {
    ...
    public static @NotNull SimpleCollisionBox getBoundingBoxFromPosAndSize(@NotNull CometPlayer player, double centerX, double minY, double centerZ, float width, float height) {
    ...
    public static double @NotNull [] getEntityDimensions(CometPlayer player, @NotNull PacketEntity entity) {
        final float scale = (float) entity.getAttributeValue(Attributes.SCALE);
    ...
    public static void expandBoundingBoxByEntityDimensions(@NotNull SimpleCollisionBox box, CometPlayer player, PacketEntity entity) {
