package ac.comet.cometac.utils.data.packetentity.dragon;
...
public final class PacketEntityEnderDragonPart extends PacketEntity {
    ...
    public PacketEntityEnderDragonPart(CometPlayer player, DragonPart part, double x, double y, double z, float width, float height) {
