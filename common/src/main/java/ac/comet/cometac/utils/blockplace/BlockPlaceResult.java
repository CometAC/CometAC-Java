...
import ac.comet.cometac.utils.blockstate.helper.BlockFaceHelper;
...
import ac.comet.cometac.utils.nmsutil.Dripstone;
...
public enum BlockPlaceResult {
    ...
    TORCH_OR_HEAD((player, place) -> {
        // type doesn't matter to comet, same hitbox.
    ...
    // As long as one of these properties is met, it is good enough for comet!
    VINE((player, place) -> {
    ...
    SCAFFOLDING((player, place) -> {
        ...
        } // else, cancel if the scaffolding is exactly 7 away, comet doesn't handle this edge case yet.
