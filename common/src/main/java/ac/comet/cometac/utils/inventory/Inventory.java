...
import ac.comet.cometac.utils.inventory.inventory.AbstractContainerMenu;
import ac.comet.cometac.utils.inventory.slot.EquipmentSlot;
import ac.comet.cometac.utils.inventory.slot.ResultSlot;
import ac.comet.cometac.utils.inventory.slot.Slot;
import ac.comet.cometac.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(CometPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
