package ac.comet.cometac.utils.worldborder;
...
public class TickBasedMovingBorderExtent implements BorderExtent {
    ...
    private double calculateSize() {
        ...
        return progress < 1.0D ? CometMath.lerp(progress, from, to) : to;
    }
    ...
    public double getMinX(double centerX, double absoluteMaxSize) {
        return CometMath.clamp(centerX - previousSize / 2.0, -absoluteMaxSize, absoluteMaxSize);
    }
    ...
    public double getMinZ(double centerZ, double absoluteMaxSize) {
        return CometMath.clamp(centerZ - previousSize / 2.0, -absoluteMaxSize, absoluteMaxSize);
    }
