...
//        }
    ...
    public SimpleCollisionBox offset(double x, double y, double z) {
        ...
        switch (offsetType) {
            ...
            case XZ:
                l = CometMath.hashCode(x, 0, z);
                offsetX = CometMath.clamp(((double) ((float) (l & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
                offsetZ = CometMath.clamp(((double) ((float) (l >> 8 & 15L) / 15.0F) - 0.5) * 0.5, -maxHorizontalModelOffset, maxHorizontalModelOffset);
