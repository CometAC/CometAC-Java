...
import ac.comet.cometac.utils.nmsutil.Ray;
...
public class SimpleCollisionBox implements CollisionBox {
    ...
    public Vector3d getCenter() {
        return new Vector3d(CometMath.lerp(0.5, this.minX, this.maxX), CometMath.lerp(0.5, this.minY, this.maxY), CometMath.lerp(0.5, this.minZ, this.maxZ));
    }
    ...
    public static Vector3i containing(double x, double y, double z) {
        return new Vector3i(CometMath.floor(x), CometMath.floor(y), CometMath.floor(z));
    }
    ...
    public static Iterable<Vector3i> betweenCornersInDirection(SimpleCollisionBox boundingBox, Vector3d directionVector) {
        int minX = CometMath.floor(boundingBox.minX);
        int minY = CometMath.floor(boundingBox.minY);
        int minZ = CometMath.floor(boundingBox.minZ);
        int maxX = CometMath.floor(boundingBox.maxX);
        int maxY = CometMath.floor(boundingBox.maxY);
        int maxZ = CometMath.floor(boundingBox.maxZ);
