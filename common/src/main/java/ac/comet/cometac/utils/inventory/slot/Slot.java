...
public class Slot {
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, CometPlayer p_150650_) {
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, CometPlayer player) {
    ...
    // No override
    public boolean allowModification(CometPlayer player) {
