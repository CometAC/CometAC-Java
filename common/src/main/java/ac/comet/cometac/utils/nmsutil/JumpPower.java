...
public class JumpPower {
    public static void jumpFromGround(@NotNull CometPlayer player, @NotNull Vector3dm vector) {
        ...
        if (player.isSprinting) {
            float radRotation = CometMath.radians(player.yaw);
    ...
    public static float getJumpPower(@NotNull CometPlayer player) {
    ...
    public static float getPlayerJumpFactor(@NotNull CometPlayer player) {
