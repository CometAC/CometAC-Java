...
import ac.comet.cometac.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import ac.comet.cometac.utils.nmsutil.BoundingBoxSize;
import ac.comet.cometac.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(CometPlayer player) {
        this.player = player;
