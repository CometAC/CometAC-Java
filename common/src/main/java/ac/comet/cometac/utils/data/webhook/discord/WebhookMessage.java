package ac.comet.cometac.utils.data.webhook.discord;

import ac.comet.cometac.utils.data.json.JsonSerializable;
...
import static ac.comet.cometac.utils.data.json.JsonSerializable.deserializeArray;
import static ac.comet.cometac.utils.data.json.JsonSerializable.serializeArray;
...
public class WebhookMessage implements JsonSerializable {
    ...
    // Files uploaded alongside the payload. Referenced from embeds via attachment://<filename>.
    private @Nullable java.util.List<Attachment> attachments;

    public record Attachment(@NotNull String filename, byte @NotNull [] data) {}

    public @NotNull WebhookMessage addAttachment(@NotNull String filename, byte @NotNull [] data) {
