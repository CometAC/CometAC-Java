...
import ac.comet.cometac.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull CometPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
