...
public class TrigHandler {
    ...
    public TrigHandler(CometPlayer player) {
        this.player = player;
    }
    ...
    public Vector3dm getVanillaMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3;
        float f4;
        float radians = CometMath.radians(f2);
    ...
    public Vector3dm getShitMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.sin(CometMath.radians(f2)) : LegacyFastMath.sin(CometMath.radians(f2));
        float f4 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.cos(CometMath.radians(f2)) : LegacyFastMath.cos(CometMath.radians(f2));
