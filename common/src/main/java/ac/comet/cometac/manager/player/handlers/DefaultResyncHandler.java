package ac.comet.cometac.manager.player.handlers;
...
public record DefaultResyncHandler(CometPlayer player) implements ResyncHandler {

    private static void resyncPositions(CometPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        CometAPI.INSTANCE.getScheduler().getRegionScheduler().execute(CometAPI.INSTANCE.getGrimPlugin(), world,
    ...
    private static void resyncPosition(CometPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        CometAPI.INSTANCE.getScheduler().getRegionScheduler().execute(CometAPI.INSTANCE.getGrimPlugin(), world, chunkX, chunkZ, () -> {
