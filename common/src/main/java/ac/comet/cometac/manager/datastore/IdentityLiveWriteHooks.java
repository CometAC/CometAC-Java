...
final class IdentityLiveWriteHooks implements LiveWriteHooks {
    ...
    @Override public void onQuitFromUserDisconnect(@NotNull User user, @Nullable CometPlayer cometPlayer, long now) {}
    @Override public void observeBrandFromCheck(@NotNull CometPlayer cometPlayer) {}
