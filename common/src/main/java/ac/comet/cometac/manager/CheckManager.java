...
import ac.comet.cometac.checks.impl.aim.AimDuplicateLook;
import ac.comet.cometac.checks.impl.aim.AimModulo360;
import ac.comet.cometac.checks.impl.aim.AuraSnapBack;
import ac.comet.cometac.checks.impl.aim.processor.AimProcessor;
import ac.comet.cometac.checks.impl.badpackets.*;
import ac.comet.cometac.checks.impl.breaking.*;
import ac.comet.cometac.checks.impl.chat.ChatA;
import ac.comet.cometac.checks.impl.chat.ChatB;
import ac.comet.cometac.checks.impl.chat.ChatC;
import ac.comet.cometac.checks.impl.chat.ChatD;
import ac.comet.cometac.checks.impl.combat.*;
import ac.comet.cometac.checks.impl.crash.*;
import ac.comet.cometac.checks.impl.inventory.*;
import ac.comet.cometac.checks.impl.elytra.*;
import ac.comet.cometac.checks.impl.exploit.ExploitA;
import ac.comet.cometac.checks.impl.exploit.ExploitB;
import ac.comet.cometac.checks.impl.groundspoof.NoFall;
import ac.comet.cometac.checks.impl.misc.ClientBrand;
import ac.comet.cometac.checks.impl.misc.GhostBlockMitigation;
import ac.comet.cometac.checks.impl.misc.PacketLogger;
import ac.comet.cometac.checks.impl.misc.Post;
import ac.comet.cometac.checks.impl.misc.TransactionOrder;
import ac.comet.cometac.checks.impl.combat.FreezeAttack;
import ac.comet.cometac.checks.impl.movement.AirStuck;
import ac.comet.cometac.checks.impl.movement.NoSlow;
import ac.comet.cometac.checks.impl.movement.PredictionRunner;
import ac.comet.cometac.checks.impl.movement.SetbackBlocker;
import ac.comet.cometac.checks.impl.movement.VehiclePredictionRunner;
import ac.comet.cometac.checks.impl.multiactions.*;
import ac.comet.cometac.checks.impl.packetorder.*;
...
import ac.comet.cometac.checks.impl.prediction.Phase;
import ac.comet.cometac.checks.impl.scaffolding.*;
import ac.comet.cometac.checks.impl.sprint.*;
import ac.comet.cometac.checks.impl.timer.*;
import ac.comet.cometac.checks.impl.vehicle.*;
import ac.comet.cometac.checks.impl.velocity.ExplosionHandler;
import ac.comet.cometac.checks.impl.velocity.KnockbackHandler;
import ac.comet.cometac.checks.type.*;
import ac.comet.cometac.events.packets.PacketChangeGameState;
import ac.comet.cometac.events.packets.PacketEntityReplication;
import ac.comet.cometac.events.packets.PacketPlayerAbilities;
import ac.comet.cometac.events.packets.PacketWorldBorder;
import ac.comet.cometac.manager.init.start.SuperDebug;
import ac.comet.cometac.platform.api.permissions.PermissionDefaultValue;
import ac.comet.cometac.player.CometPlayer;
import ac.comet.cometac.predictionengine.GhostBlockDetector;
import ac.comet.cometac.predictionengine.SneakingEstimator;
import ac.comet.cometac.utils.anticheat.update.*;
import ac.comet.cometac.utils.latency.CompensatedCameraEntity;
import ac.comet.cometac.utils.latency.CompensatedCooldown;
import ac.comet.cometac.utils.latency.CompensatedFireworks;
import ac.comet.cometac.utils.latency.CompensatedInventory;
...
public class CheckManager {
    ...
    public CheckManager(CometPlayer player) {
    ...
    private void init() {
        ...
        for (final AbstractCheck check : allChecks.values()) {
            ...
            for (String permissionName : permissions) {
                permissionName += id;
                CometAPI.INSTANCE.getPermissionManager().registerPermission(permissionName, PermissionDefaultValue.FALSE);
            }
        }
    }
}
