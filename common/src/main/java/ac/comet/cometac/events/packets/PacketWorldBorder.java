...
import ac.comet.cometac.utils.worldborder.BorderExtent;
import ac.comet.cometac.utils.worldborder.RealTimeMovingBorderExtent;
import ac.comet.cometac.utils.worldborder.StaticBorderExtent;
import ac.comet.cometac.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(CometPlayer playerData) {
        super(playerData);
