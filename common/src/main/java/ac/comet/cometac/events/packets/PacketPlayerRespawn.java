...
import ac.comet.cometac.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.addRealTimeTaskNext(() -> {
                ...
                if (!CometAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(CometPlayer player, WrapperPlayServerRespawn respawn) {
