...
import ac.comet.cometac.checks.impl.badpackets.BadPacketsW;
...
public class PacketPlayerAttack extends PacketListenerAbstract {
    ...
    private void onAttack(PacketReceiveEvent event, CometPlayer player, int entityId) {
    ...
    private boolean isInvalidEntity(PacketReceiveEvent event, CometPlayer player, int entityId) {
