package ac.comet.cometac.events.packets.worldreader;

import ac.comet.cometac.CometAPI;
import ac.comet.cometac.events.packets.worldreader.multiblockchange.LegacyMultiBlockChangeHandler;
import ac.comet.cometac.events.packets.worldreader.multiblockchange.V1160MultiBlockChangeBitRepackHandler;
import ac.comet.cometac.events.packets.worldreader.multiblockchange.VersionedMultiBlockChangeHandler;
import ac.comet.cometac.player.CometPlayer;
import ac.comet.cometac.utils.chunks.Column;
import ac.comet.cometac.utils.data.TeleportData;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(CometPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(CometPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, CometPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ) {
    ...
    public void unloadChunk(CometPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(CometPlayer player, PacketSendEvent event) {
