...
import ac.comet.cometac.utils.inventory.InventoryDesyncStatus;
...
public class PacketPlayerWindow extends PacketListenerAbstract {
    ...
    private void handleInventoryOpen(CometPlayer player) {
    ...
    private void handleInventoryClose(CometPlayer player, InventoryDesyncStatus desyncStatus) {
        player.hasInventoryOpen = false;
        player.inventoryDesyncStatus = desyncStatus;
    }

    public InventoryDesyncStatus getContainerDesyncStatus(CometPlayer player, String legacyType, int modernType) {
    ...
    public boolean isNearNetherPortal(CometPlayer player) {
