...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final CometPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final CometPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
