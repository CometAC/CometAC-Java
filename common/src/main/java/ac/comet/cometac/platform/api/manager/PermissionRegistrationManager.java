...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "cometac.exempt.checkname")
     * are available for autocomplete before Comet attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "cometac.exempt").
