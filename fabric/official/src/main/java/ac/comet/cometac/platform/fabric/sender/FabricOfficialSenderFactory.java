...
public class FabricOfficialSenderFactory extends AbstractFabricSenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = CometACFabricOfficialLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = CometACFabricOfficialLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    public void sendMessage(CommandSourceStack source, Component message) {
        net.minecraft.network.chat.Component nativeText =
                (net.minecraft.network.chat.Component) CometACFabricOfficialLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message);
