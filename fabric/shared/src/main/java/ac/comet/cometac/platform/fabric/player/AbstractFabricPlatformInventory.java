...
import ac.comet.cometac.platform.fabric.utils.FabricItemContextHook;
...
public abstract class AbstractFabricPlatformInventory implements PlatformInventory {
     ...
     * inventory owner bound so Polymer can encode the item instead of crashing (CometAnticheat/Comet#2701).
