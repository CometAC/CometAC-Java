package ac.comet.cometac.platform.fabric.utils;
...
/**
 * Binds a Polymer/fabric-api {@code PacketContext} around Comet's out-of-pipeline {@code ItemStack}
 * encoding so that Polymer can encode items without crashing. See CometAnticheat/Comet#2701.
 *
 ...
 *
 * <p>Comet encodes {@code ItemStack}s outside of the Netty pipeline when it reads a player's inventory
    ...
    static {
        ...
        if (FabricLoader.getInstance().isModLoaded("polymer-core")) {
            try {
                ...
                LogUtil.info("[CometAC] Polymer is present but fabric-api's PacketContext API is unavailable; "
