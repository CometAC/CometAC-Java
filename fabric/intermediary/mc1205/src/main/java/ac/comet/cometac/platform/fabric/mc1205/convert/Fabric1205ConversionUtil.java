package ac.comet.cometac.platform.fabric.mc1205.convert;
...
public class Fabric1205ConversionUtil implements IFabricConversionUtil {
    ...
    public ItemStack fromFabricItemStack(Object fabricItemStack) {
        ...
        try {
            RegistryAccess registryManager = CometACFabricIntermediaryLoaderPlugin.FABRIC_SERVER.registryAccess();
