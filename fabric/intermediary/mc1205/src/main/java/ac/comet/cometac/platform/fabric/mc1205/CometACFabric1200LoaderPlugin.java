...
import ac.comet.cometac.platform.fabric.mc1205.player.Fabric1202PlatformPlayer;
...
public class CometACFabric1200LoaderPlugin extends CometACFabric1190LoaderPlugin {

    public CometACFabric1200LoaderPlugin() {
        super(
