...
import ac.comet.cometac.platform.fabric.utils.world.FabricIntermediaryLevelChunkUtil;
...
abstract class FabricIntermediaryLevelMixin implements LevelAccessor {
    ...
    public boolean cometac$isLoaded() {
        return CometACFabricIntermediaryLoaderPlugin.FABRIC_SERVER.getLevel(this.dimension()) != null;
    }
}
