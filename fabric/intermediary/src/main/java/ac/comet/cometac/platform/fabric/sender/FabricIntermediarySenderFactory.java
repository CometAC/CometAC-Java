package ac.comet.cometac.platform.fabric.sender;
...
public class FabricIntermediarySenderFactory extends AbstractFabricSenderFactory<CommandSourceStack> {
    ...
    private final AbstractFabricPlatformServer platformServer = CometACFabricIntermediaryLoaderPlugin.LOADER.getPlatformServer();
    private final IFabricMessageUtil fabricMessageUtils = CometACFabricIntermediaryLoaderPlugin.LOADER.getFabricMessageUtils();
    ...
    public void sendMessage(CommandSourceStack sender, Component message) {
        net.minecraft.network.chat.Component nativeText =
                (net.minecraft.network.chat.Component) CometACFabricIntermediaryLoaderPlugin.LOADER.getFabricConversionUtil().toNativeText(message);
