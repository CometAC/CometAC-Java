# Contributing to CometAC

Thank you for your interest in contributing to CometAC. This document outlines the guidelines for
making pull
...
- **Compatibility**
  ...
  the [supported environments](https://github.com/CometAnticheat/Comet/wiki/Supported-environments) (Spigot, Paper, Folia, Fabric, etc.)
...
- CometAC is built using [Gradle](https://gradle.org/) kotlin scripts.
- Java 21 is currently required to build the project. A minimum of Java 17 is required to run it.

### Questions & Support

- Join our [Discord](https://discord.cometac.ac) if you have questions or need assistance.
- Refer to the [Wiki](https://github.com/CometAnticheat/Comet/wiki) for project documentation.
