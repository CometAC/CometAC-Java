...
public class BukkitPermissionRegistrationManager implements PermissionRegistrationManager {
     ...
     * like "cometac.exempt.checkname") that are generated at runtime. Most other static permissions
     * (e.g., "cometac.exempt", "cometac.alerts.enable-on-join") are registered with their defaults
     ...
     *
     * @param name         The permission node to register (e.g., "cometac.exempt.checkname").
