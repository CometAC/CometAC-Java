package ac.comet.cometac.platform.bukkit.world;
...
public class BukkitPlatformChunk implements PlatformChunk {
    ...
    private static final Map<BlockData, Integer> blockDataToId = CometAPI.INSTANCE.getPlatform() == Platform.FOLIA ? new ConcurrentHashMap<>() : new HashMap<>();
